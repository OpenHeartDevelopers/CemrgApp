...
const std::string MmcwViewPlot::VIEW_ID = "my.cemrgproject.views.mmcwviewplot";

void MmcwViewPlot::CreateQtPartControl(QWidget *parent) {

    //Create GUI widgets from the Qt Designer's .ui file
    m_Controls.setupUi(parent);
    connect(m_Controls.button_1, SIGNAL(clicked()), this, SLOT(PlotData()));
    connect(m_Controls.button_2, SIGNAL(clicked()), this, SLOT(FilePlot()));
    connect(m_Controls.button_3, SIGNAL(clicked()), this, SLOT(BullPlot()));

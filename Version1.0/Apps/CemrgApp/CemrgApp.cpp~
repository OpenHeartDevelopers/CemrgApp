...
int main(int argc, char** argv)
{
    ...
    myApp.setApplicationName("CemrgApp v1.0");
    myApp.setOrganizationName("CemrgOrg");
    ...
    myApp.setProperty(mitk::BaseApplication::PROP_APPLICATION, "my.cemrgproject.cemrgapp");
    return myApp.run();
}

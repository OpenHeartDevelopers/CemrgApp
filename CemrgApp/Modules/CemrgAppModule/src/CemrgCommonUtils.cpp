...
CemrgCommonUtils::NiftiQformStatus AssessNiftiQform(
    QString path, QString& message, NiftiHeaderFields& fields, bool& isCompressed) {

    using Status = CemrgCommonUtils::NiftiQformStatus;
...
QString CemrgCommonUtils::NiftiQformStatusToString(NiftiQformStatus status) {
    switch (status) {
...
CemrgCommonUtils::NiftiQformStatus CemrgCommonUtils::InspectNiftiQform(QString pathToImage, QString& message) {
    NiftiHeaderFields fields;
    bool isCompressed = false;
    return AssessNiftiQform(pathToImage, message, fields, isCompressed);
}

CemrgCommonUtils::NiftiQformStatus CemrgCommonUtils::RepairNiftiQform(QString pathToImage, QString& message) {
    NiftiHeaderFields fields;
    bool isCompressed = false;
